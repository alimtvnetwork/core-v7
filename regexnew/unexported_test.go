...
func Test_I17_Create_New(t *testing.T) {
	r, err := Create(`^abc$`)
	if err != nil || r == nil {
...
func Test_I17_Create_Cached(t *testing.T) {
...
func Test_I17_Create_Invalid(t *testing.T) {
...
func Test_I17_CreateLock(t *testing.T) {
...
func Test_I17_CreateLockIf_WithLock(t *testing.T) {
...
func Test_I17_CreateLockIf_WithoutLock(t *testing.T) {
...
func Test_I17_CreateMust_Valid(t *testing.T) {
...
func Test_I17_CreateMust_Cached(t *testing.T) {
...
func Test_I17_CreateMust_Panic(t *testing.T) {
	defer func() {
		if r := recover(); r == nil {
...
func Test_I17_CreateMustLockIf_WithLock(t *testing.T) {
...
func Test_I17_CreateMustLockIf_WithoutLock(t *testing.T) {
...
func Test_I17_CreateApplicableLock_Valid(t *testing.T) {
...
func Test_I17_CreateApplicableLock_Invalid(t *testing.T) {
...
func Test_I17_NewMustLock(t *testing.T) {
...
func Test_I17_IsMatchLock_Match(t *testing.T) {
	if !IsMatchLock(`^\d+$`, "123") {
		t.Fatal("expected match")
	}
}

func Test_I17_IsMatchLock_NoMatch(t *testing.T) {
	if IsMatchLock(`^\d+$`, "abc") {
		t.Fatal("expected no match")
	}
}

func Test_I17_IsMatchLock_InvalidRegex(t *testing.T) {
	if IsMatchLock(`[invalid`, "abc") {
		t.Fatal("expected false for invalid regex")
	}
}

func Test_I17_IsMatchFailed_Match(t *testing.T) {
	if IsMatchFailed(`^\d+$`, "123") {
		t.Fatal("expected not failed for match")
	}
}

func Test_I17_IsMatchFailed_NoMatch(t *testing.T) {
	if !IsMatchFailed(`^\d+$`, "abc") {
		t.Fatal("expected failed for no match")
	}
}

func Test_I17_MatchError_Match(t *testing.T) {
...
func Test_I17_MatchError_NoMatch(t *testing.T) {
...
func Test_I17_MatchError_InvalidPattern(t *testing.T) {
...
func Test_I17_MatchErrorLock_Match(t *testing.T) {
...
func Test_I17_MatchErrorLock_NoMatch(t *testing.T) {
...
func Test_I17_MatchUsingFuncErrorLock_Match(t *testing.T) {
...
func Test_I17_MatchUsingFuncErrorLock_NoMatch(t *testing.T) {
	fn := func(r *regexp.Regexp, s string) bool { return r.MatchString(s) }
...
func Test_I17_MatchUsingCustomizeErrorFuncLock_Match(t *testing.T) {
	fn := func(r *regexp.Regexp, s string) bool { return r.MatchString(s) }
...
func Test_I17_MatchUsingCustomizeErrorFuncLock_NoMatch_DefaultErr(t *testing.T) {
	fn := func(r *regexp.Regexp, s string) bool { return r.MatchString(s) }
...
// newCreator tests
func Test_I17_NewCreator_Lazy(t *testing.T) {
...
func Test_I17_NewCreator_LazyLock(t *testing.T) {
...
func Test_I17_NewCreator_Default(t *testing.T) {
...
func Test_I17_NewCreator_DefaultLock(t *testing.T) {
...
func Test_I17_NewCreator_DefaultLockIf(t *testing.T) {
...
func Test_I17_NewCreator_DefaultApplicableLock(t *testing.T) {
...
func Test_I17_LazyRegexCreator_TwoLock(t *testing.T) {
...
func Test_I17_LazyRegexCreator_ManyUsingLock_Empty(t *testing.T) {
...
func Test_I17_LazyRegexCreator_ManyUsingLock_Valid(t *testing.T) {
...
func Test_I17_LazyRegexCreator_AllPatternsMap(t *testing.T) {
...
func Test_I17_LazyRegexCreator_NewLockIf_Lock(t *testing.T) {
...
func Test_I17_LazyRegexCreator_NewLockIf_NoLock(t *testing.T) {
...
func Test_I17_LazyRegex_IsNull(t *testing.T) {
	var lr *LazyRegex
	if !lr.IsNull() {
...
func Test_I17_LazyRegex_IsDefined(t *testing.T) {
...
func Test_I17_LazyRegex_IsUndefined_Nil(t *testing.T) {
	var lr *LazyRegex
	if !lr.IsUndefined() {
...
func Test_I17_LazyRegex_IsApplicable(t *testing.T) {
...
func Test_I17_LazyRegex_IsApplicable_Nil(t *testing.T) {
	var lr *LazyRegex
	if lr.IsApplicable() {
...
func Test_I17_LazyRegex_IsApplicable_Invalid(t *testing.T) {
...
func Test_I17_LazyRegex_IsApplicable_Cached(t *testing.T) {
...
func Test_I17_LazyRegex_Compile_Undefined(t *testing.T) {
	lr := &LazyRegex{}
	_, err := lr.Compile()
	if err == nil {
...
func Test_I17_LazyRegex_CompileMust_Success(t *testing.T) {
...
func Test_I17_LazyRegex_CompileMust_Panic(t *testing.T) {
	defer func() {
		if r := recover(); r == nil {
			t.Fatal("expected panic")
		}
...
func Test_I17_LazyRegex_OnRequiredCompiled_Nil(t *testing.T) {
	var lr *LazyRegex
...
func Test_I17_LazyRegex_OnRequiredCompiled_AlreadyCompiled(t *testing.T) {
...
func Test_I17_LazyRegex_OnRequiredCompiledMust_Success(t *testing.T) {
	lr := New.Lazy(`^i17-onreqmust$`)
	lr.OnRequiredCompiledMust()
}

func Test_I17_LazyRegex_OnRequiredCompiledMust_Panic(t *testing.T) {
	defer func() {
		if r := recover(); r == nil {
			t.Fatal("expected panic")
		}
...
func Test_I17_LazyRegex_HasError_Valid(t *testing.T) {
...
func Test_I17_LazyRegex_HasError_Invalid(t *testing.T) {
	lr := &LazyRegex{pattern: "[", compiler: CreateLock}
	if !lr.HasError() {
		t.Fatal("expected error")
	}
...
func Test_I17_LazyRegex_HasAnyIssues_Nil(t *testing.T) {
	var lr *LazyRegex
	if !lr.HasAnyIssues() {
...
func Test_I17_LazyRegex_HasAnyIssues_Valid(t *testing.T) {
...
func Test_I17_LazyRegex_IsInvalid_Nil(t *testing.T) {
	var lr *LazyRegex
	if !lr.IsInvalid() {
...
func Test_I17_LazyRegex_IsInvalid_Valid(t *testing.T) {
...
func Test_I17_LazyRegex_CompiledError(t *testing.T) {
...
func Test_I17_LazyRegex_Error(t *testing.T) {
	lr := New.Lazy(`^i17-err$`)
	err := lr.Error()
	if err != nil {
		t.Fatal("unexpected error")
...
func Test_I17_LazyRegex_MustBeSafe_Success(t *testing.T) {
	lr := New.Lazy(`^i17-mustbesafe$`)
	lr.MustBeSafe()
}

func Test_I17_LazyRegex_MustBeSafe_Panic(t *testing.T) {
	defer func() {
		if r := recover(); r == nil {
			t.Fatal("expected panic")
		}
...
func Test_I17_LazyRegex_String_Nil(t *testing.T) {
	var lr *LazyRegex
	if lr.String() != "" {
...
func Test_I17_LazyRegex_String_Valid(t *testing.T) {
	lr := New.Lazy(`^i17-str$`)
...
func Test_I17_LazyRegex_FullString_Nil(t *testing.T) {
	var lr *LazyRegex
	if lr.FullString() != "" {
		t.Fatal("expected empty for nil")
	}
...
func Test_I17_LazyRegex_FullString_Valid(t *testing.T) {
...
func Test_I17_LazyRegex_Pattern_Nil(t *testing.T) {
	var lr *LazyRegex
	if lr.Pattern() != "" {
		t.Fatal("expected empty for nil")
	}
...
func Test_I17_LazyRegex_Pattern_Valid(t *testing.T) {
...
func Test_I17_LazyRegex_MatchError_Match(t *testing.T) {
	lr := New.Lazy(`^\d+$`)
...
func Test_I17_LazyRegex_MatchError_NoMatch(t *testing.T) {
	lr := New.Lazy(`^\d+$`)
...
func Test_I17_LazyRegex_MatchUsingFuncError_Match(t *testing.T) {
	lr := New.Lazy(`^\d+$`)
	fn := func(r *regexp.Regexp, s string) bool { return r.MatchString(s) }
...
func Test_I17_LazyRegex_MatchUsingFuncError_NoMatch(t *testing.T) {
	lr := New.Lazy(`^\d+$`)
	fn := func(r *regexp.Regexp, s string) bool { return r.MatchString(s) }
...
func Test_I17_LazyRegex_IsMatch(t *testing.T) {
	lr := New.Lazy(`^\d+$`)
	if !lr.IsMatch("123") {
		t.Fatal("expected match")
	}
...
func Test_I17_LazyRegex_IsMatchBytes(t *testing.T) {
	lr := New.Lazy(`^\d+$`)
...
func Test_I17_LazyRegex_IsFailedMatch(t *testing.T) {
	lr := New.Lazy(`^\d+$`)
...
func Test_I17_LazyRegex_IsFailedMatch_Invalid(t *testing.T) {
	lr := &LazyRegex{pattern: "[", compiler: CreateLock}
	if !lr.IsFailedMatch("abc") {
...
func Test_I17_LazyRegex_IsFailedMatchBytes(t *testing.T) {
	lr := New.Lazy(`^\d+$`)
...
func Test_I17_LazyRegex_FirstMatchLine_Match(t *testing.T) {
	lr := New.Lazy(`(\d+)`)
...
func Test_I17_LazyRegex_FirstMatchLine_NoMatch(t *testing.T) {
	lr := New.Lazy(`^zzz$`)
...
func Test_I17_LazyRegex_FirstMatchLine_Invalid(t *testing.T) {
	lr := &LazyRegex{pattern: "[", compiler: CreateLock}
	match, isInvalid := lr.FirstMatchLine("abc")
	if !isInvalid || match != "" {
...
func Test_I17_CompiledRegexVars(t *testing.T) {
