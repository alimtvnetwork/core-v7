...
func Test_Cov14_ProcessAsync_Valid(t *testing.T) {
	// Arrange
	items := []any{"a", "b", "c"}
...
func Test_Cov14_ProcessAsync_Empty(t *testing.T) {
	// Act
	result := stringslice.ProcessAsync(func(index int, item any) string {
		return ""
	})
...
func Test_Cov14_ProcessOptionAsync_SkipOnNil(t *testing.T) {
	// Arrange
	items := []any{"a", "b", ""}
...
func Test_Cov14_ProcessOptionAsync_NoSkip(t *testing.T) {
	// Arrange
	items := []any{"a", "", "c"}
...
func Test_Cov14_ProcessOptionAsync_Empty(t *testing.T) {
	// Act
	result := stringslice.ProcessOptionAsync(
		true,
...
func Test_Cov14_LinesAsyncProcess_Valid(t *testing.T) {
	// Arrange
...
func Test_Cov14_LinesAsyncProcess_Empty(t *testing.T) {
	// Act
...
func Test_Cov14_AnyLinesProcessAsync_Valid(t *testing.T) {
	// Arrange
	lines := []int{1, 2, 3}
...
func Test_Cov14_AnyLinesProcessAsync_Nil(t *testing.T) {
	// Act
	result := stringslice.AnyLinesProcessAsyncUsingProcessor(
		nil,
...
func Test_Cov14_AnyLinesProcessAsync_NotSlice(t *testing.T) {
	// Act
	result := stringslice.AnyLinesProcessAsyncUsingProcessor(
		"not-a-slice",
		func(index int, lineIn any) string { return "" },
...
func Test_Cov14_AnyLinesProcessAsync_EmptySlice(t *testing.T) {
	// Act
	result := stringslice.AnyLinesProcessAsyncUsingProcessor(
		[]string{},
		func(index int, lineIn any) string { return "" },
...
func Test_Cov14_ExpandByFunc_Valid(t *testing.T) {
	// Arrange
...
func Test_Cov14_ExpandByFunc_Empty(t *testing.T) {
	// Act
...
func Test_Cov14_ExpandByFunc_ExpandReturnsEmpty(t *testing.T) {
	// Arrange
	slice := []string{"a", "b"}
...
func Test_Cov14_ExpandBySplit_Valid(t *testing.T) {
	// Arrange
	slice := []string{"a-b", "c-d"}
...
func Test_Cov14_ExpandBySplit_Empty(t *testing.T) {
	// Act
...
func Test_Cov14_ExpandBySplits_MultiSplitters(t *testing.T) {
	// Arrange
	slice := []string{"a-b.c"}
...
func Test_Cov14_ExpandBySplits_NoSplitters(t *testing.T) {
	// Arrange
	slice := []string{"a-b"}
...
func Test_Cov14_SafeIndexRanges_Valid(t *testing.T) {
	// Arrange
...
func Test_Cov14_SafeIndexRanges_NegativeRange(t *testing.T) {
	// Arrange
	slice := []string{"a", "b"}
...
func Test_Cov14_SafeIndexRanges_OutOfBounds(t *testing.T) {
	// Arrange
	slice := []string{"a", "b"}
...
func Test_Cov14_SafeIndexes_OutOfBounds(t *testing.T) {
	// Arrange
	slice := []string{"a", "b"}
...
func Test_Cov14_SafeIndexesDefaultWithDetail_Valid(t *testing.T) {
	// Arrange
	slice := []string{"a", "b", "c"}
...
func Test_Cov14_SafeIndexesDefaultWithDetail_Empty(t *testing.T) {
	// Act
...
func Test_Cov14_SafeIndexesDefaultWithDetail_OutOfBounds(t *testing.T) {
	// Arrange
	slice := []string{"a", "b"}
...
func Test_Cov14_SafeRangeItems_Valid(t *testing.T) {
	// Arrange
	slice := []string{"a", "b", "c", "d"}
...
func Test_Cov14_SafeRangeItems_Nil(t *testing.T) {
	// Act
...
func Test_Cov14_SafeRangeItems_Empty(t *testing.T) {
	// Act
...
func Test_Cov14_SafeRangeItems_StartBeyondLastIndex(t *testing.T) {
	// Arrange
	slice := []string{"a", "b"}
...
func Test_Cov14_SafeRangeItems_EndBeyondLastIndex(t *testing.T) {
	// Arrange
	slice := []string{"a", "b", "c"}
...
func Test_Cov14_IndexesDefault_Empty(t *testing.T) {
	// Act
...
func Test_Cov14_IndexesDefault_NoIndexes(t *testing.T) {
	// Act
...
func Test_Cov14_NonEmptyIf_True(t *testing.T) {
	// Arrange
	slice := []string{"a", "", "b"}
...
func Test_Cov14_NonEmptyIf_False(t *testing.T) {
	// Arrange
	slice := []string{"a", "", "b"}
...
func Test_Cov14_NonEmptyJoin_Valid(t *testing.T) {
	// Arrange
	slice := []string{"a", "", "b"}
...
func Test_Cov14_NonEmptyJoin_Nil(t *testing.T) {
	// Act
...
func Test_Cov14_NonEmptyJoin_Empty(t *testing.T) {
	// Act
...
func Test_Cov14_NonEmptyJoinPtr(t *testing.T) {
	// Arrange
	slice := []string{"a", "", "b"}
...
func Test_Cov14_NonEmptyJoinPtr_Empty(t *testing.T) {
	// Act
...
func Test_Cov14_NonWhitespaceJoin_Valid(t *testing.T) {
	// Arrange
	slice := []string{"a", "   ", "b"}
...
func Test_Cov14_NonWhitespaceJoin_Nil(t *testing.T) {
	// Act
...
func Test_Cov14_NonWhitespaceJoin_Empty(t *testing.T) {
	// Act
...
func Test_Cov14_NonWhitespaceJoinPtr(t *testing.T) {
	// Arrange
	slice := []string{"a", "   ", "b"}
...
func Test_Cov14_NonWhitespaceJoinPtr_Empty(t *testing.T) {
	// Act
...
func Test_Cov14_TrimmedEachWordsIf_True(t *testing.T) {
	// Arrange
	slice := []string{" a ", "  ", " b "}
...
func Test_Cov14_PrependLineNew(t *testing.T) {
	// Arrange
	slice := []string{"b", "c"}
...
func Test_Cov14_AppendLineNew(t *testing.T) {
	// Arrange
	slice := []string{"a", "b"}
...
func Test_Cov14_LinesProcess_Valid(t *testing.T) {
	// Arrange
	lines := []string{"a", "b", "c"}
...
func Test_Cov14_LinesProcess_Break(t *testing.T) {
	// Arrange
	lines := []string{"a", "b", "c"}
...
func Test_Cov14_LinesProcess_Empty(t *testing.T) {
	// Act
...
func Test_Cov14_LinesProcess_SkipFalse(t *testing.T) {
	// Arrange
	lines := []string{"a", "b", "c"}
...
func Test_Cov14_LinesSimpleProcess_Valid(t *testing.T) {
	// Arrange
	lines := []string{"a", "b"}
...
func Test_Cov14_LinesSimpleProcess_Empty(t *testing.T) {
	// Act
...
func Test_Cov14_LinesSimpleProcessNoEmpty_Valid(t *testing.T) {
	// Arrange
	lines := []string{"a", "b", ""}
...
func Test_Cov14_LinesSimpleProcessNoEmpty_Empty(t *testing.T) {
	// Act
...
func Test_Cov14_NonEmptySlice_Valid(t *testing.T) {
	// Arrange
	slice := []string{"a", "", "b"}
...
func Test_Cov14_NonEmptySlice_Empty(t *testing.T) {
	// Act
...
func Test_Cov14_NonEmptyStrings_Nil(t *testing.T) {
	// Act
...
func Test_Cov14_NonWhitespace_Nil(t *testing.T) {
	// Act
...
func Test_Cov14_NonWhitespace_Empty(t *testing.T) {
	// Act
...
func Test_Cov14_NonWhitespacePtr_Empty(t *testing.T) {
	// Act
...
func Test_Cov14_NonNullStrings_Nil(t *testing.T) {
	// Act
...
func Test_Cov14_SplitTrimmedNonEmpty(t *testing.T) {
	// Act
...
func Test_Cov14_SplitTrimmedNonEmptyAll(t *testing.T) {
	// Act
...
func Test_Cov14_SafeIndexAtUsingLastIndex_Valid(t *testing.T) {
	// Arrange
	slice := []string{"a", "b", "c"}
...
func Test_Cov14_SafeIndexAtUsingLastIndex_OutOfBounds(t *testing.T) {
	// Arrange
	slice := []string{"a"}
...
func Test_Cov14_PrependNew_Empty(t *testing.T) {
	// Act
