...
func Test_Cov22_DeserializePayloadTo_Valid(t *testing.T) {
	// Arrange
...
func Test_Cov22_DeserializePayloadTo_NilWrapper(t *testing.T) {
	// Arrange
...
func Test_Cov22_DeserializePayloadToMust_Valid(t *testing.T) {
	// Arrange
	type testData struct {
		Name string `json:"Name"`
	}
...
func Test_Cov22_DeserializePayloadToSlice_Valid(t *testing.T) {
	// Arrange
	type testData struct {
		Name string `json:"Name"`
	}
...
func Test_Cov22_DeserializePayloadToSlice_NilWrapper(t *testing.T) {
	// Arrange
	type testData struct{ Name string }
...
func Test_Cov22_DeserializePayloadToSliceMust_Panics(t *testing.T) {
	// Arrange
	type testData struct{ Name string }
	panicked := false
...
func Test_Cov22_DeserializeAttributesPayloadTo_Valid(t *testing.T) {
	// Arrange
	type cfg struct {
...
func Test_Cov22_DeserializeAttributesPayloadTo_NilAttr(t *testing.T) {
	// Arrange
...
func Test_Cov22_DeserializeAttributesPayloadToMust_Panics(t *testing.T) {
	// Arrange
	type cfg struct{ Enabled bool }
	panicked := false
...
func Test_Cov22_DeserializeAttributesPayloadToSlice_Valid(t *testing.T) {
	// Arrange
	type item struct {
		V int `json:"V"`
	}
