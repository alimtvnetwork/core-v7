...
func Test_Cov17_Attributes_IsEqual_ErrorDifferent(t *testing.T) {
	// Arrange
...
func Test_Cov17_Attributes_IsEqual_KeyValuesDifferent(t *testing.T) {
...
func Test_Cov17_Attributes_Clone_Valid(t *testing.T) {
	// Arrange
...
func Test_Cov17_Attributes_AnyKeyReflectSetTo_NilKV(t *testing.T) {
	// Arrange
	attr := corepayload.New.Attributes.Empty()
	var target string
...
func Test_Cov17_Attributes_ParseInjectUsingJsonMust_Valid(t *testing.T) {
	// Arrange
...
func Test_Cov17_Attributes_BasicErrorDeserializedTo_EmptyError(t *testing.T) {
	// Arrange
	attr := corepayload.New.Attributes.Empty()
...
func Test_Cov17_PayloadWrapper_IsStandardTaskEntityEqual_CastFail(t *testing.T) {
	// Arrange
	wrapper := &corepayload.PayloadWrapper{
		Name: "test",
	}
...
func Test_Cov17_PayloadWrapper_Username_EmptyAttributes(t *testing.T) {
	// Arrange
	wrapper := &corepayload.PayloadWrapper{}
...
func Test_Cov17_PayloadWrapper_Error_EmptyError(t *testing.T) {
	// Arrange
	wrapper := &corepayload.PayloadWrapper{}
...
func Test_Cov17_PayloadWrapper_PayloadDeserializeMust_Valid(t *testing.T) {
	// Arrange
	wrapper := &corepayload.PayloadWrapper{
...
func Test_Cov17_PayloadWrapper_ParseInjectUsingJsonMust_Valid(t *testing.T) {
	// Arrange
...
func Test_Cov17_PayloadWrapper_Clone_Error(t *testing.T) {
...
func Test_Cov17_TypedPayloadWrapper_UnmarshalJSON_Valid(t *testing.T) {
	// Arrange
...
func Test_Cov17_TypedPayloadWrapper_SetTypedData_NilWrapper(t *testing.T) {
	// Arrange
	typed := &corepayload.TypedPayloadWrapper[string]{}
...
func Test_Cov17_TypedPayloadWrapper_Reparse_NilWrapper(t *testing.T) {
	// Arrange
	typed := &corepayload.TypedPayloadWrapper[string]{}
...
func Test_Cov17_TypedPayloadCollection_Clone_Error(t *testing.T) {
	// Arrange
	typed, _ := corepayload.NewTypedPayloadWrapperFrom("test", "id1", "entity", "hello")
...
func Test_Cov17_TypedPayloadCollection_CloneMust_Valid(t *testing.T) {
	// Arrange
	typed, _ := corepayload.NewTypedPayloadWrapperFrom("test", "id1", "entity", "hello")
	collection := corepayload.NewTypedPayloadCollectionSingle(typed)
...
func Test_Cov17_TypedPayloadCollection_NewFromDataMust_Valid(t *testing.T) {
	// Act & Assert
...
func Test_Cov17_TypedPayloadCollection_HasErrors_NoErrors(t *testing.T) {
	// Arrange
	typed, _ := corepayload.NewTypedPayloadWrapperFrom("test", "id1", "entity", "hello")
	collection := corepayload.NewTypedPayloadCollectionSingle(typed)
...
func Test_Cov17_TypedPayloadCollection_Errors_Empty(t *testing.T) {
	// Arrange
...
func Test_Cov17_TypedPayloadCollection_MergedError_None(t *testing.T) {
	// Arrange
	collection := corepayload.EmptyTypedPayloadCollection[string]()
...
func Test_Cov17_TypedPayloadCollection_MergedError_Single(t *testing.T) {
	// Arrange
	typed, _ := corepayload.NewTypedPayloadWrapperFrom("test", "id1", "entity", "hello")
	collection := corepayload.NewTypedPayloadCollectionSingle(typed)
...
func Test_Cov17_PayloadsCollection_ParseInjectUsingJsonMust_Valid(t *testing.T) {
	// Arrange
