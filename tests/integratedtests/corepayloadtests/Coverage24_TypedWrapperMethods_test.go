...
func Test_Cov24_TypedPayloadWrapper_GetAsString(t *testing.T) {
	// Arrange
...
func Test_Cov24_TypedPayloadWrapper_GetAsInt(t *testing.T) {
	// Arrange
...
func Test_Cov24_TypedPayloadWrapper_GetAsBool(t *testing.T) {
	// Arrange
...
func Test_Cov24_TypedPayloadWrapper_ValueInt(t *testing.T) {
	// Arrange
	tw, _ := corepayload.NewTypedPayloadWrapperFrom[int]("test", "1", "int", 42)
...
func Test_Cov24_TypedPayloadWrapper_ValueBool(t *testing.T) {
	// Arrange
	tw, _ := corepayload.NewTypedPayloadWrapperFrom[bool]("test", "1", "bool", true)
