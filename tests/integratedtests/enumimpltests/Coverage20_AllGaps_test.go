...
func Test_Cov20_DynamicMap_Set_NilPtr(t *testing.T) {
	// Arrange
...
func Test_Cov20_DynamicMap_AddNewOnly_NilPtr(t *testing.T) {
	// Arrange
	var dm *enumimpl.DynamicMap
...
func Test_Cov20_DynamicMap_Set_NilMap_CreatesNew(t *testing.T) {
	// Arrange
...
func Test_Cov20_DynamicMap_DiffRawUsingDifferChecker(t *testing.T) {
	// Arrange
...
func Test_Cov20_BasicString_UnmarshalToValue_NotFound(t *testing.T) {
	// Arrange
