...
func Test_Cov6_BasicInt32_Default(t *testing.T) {
	// Arrange
	type myInt32 int32
...
func Test_Cov6_BasicInt32_CreateUsingMap(t *testing.T) {
	// Arrange
...
func Test_Cov6_BasicUInt16_Default(t *testing.T) {
	// Arrange
...
func Test_Cov6_BasicUInt16_CreateUsingMap(t *testing.T) {
	// Arrange
...
func Test_Cov6_FormatUsingFmt(t *testing.T) {
	// Arrange
...
func Test_Cov6_DynamicMap_Set(t *testing.T) {
	// Arrange
...
func Test_Cov6_BasicString_CreateUsingNamesSpread(t *testing.T) {
	// Arrange
...
func Test_Cov6_LeftRightDiffChecker_SameValues(t *testing.T) {
	// Arrange
...
func Test_Cov6_DynamicMap_LogExpectingMessage(t *testing.T) {
	// Arrange
	dm := &enumimpl.DynamicMap{"a": 1}
...
func Test_Cov6_DynamicMap_DiffJsonMessageUsingDifferChecker(t *testing.T) {
	// Arrange
	dm := &enumimpl.DynamicMap{"a": 1}
...
func Test_Cov6_DynamicMap_SortedKeyAnyValues_StringValues(t *testing.T) {
	// Arrange
