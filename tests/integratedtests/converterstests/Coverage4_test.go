...
func Test_Cov4_BytesTo_String_Empty(t *testing.T) {
	// Arrange
...
func Test_Cov4_BytesTo_String_NonEmpty(t *testing.T) {
	// Arrange
...
func Test_Cov4_BytesTo_PtrString_Empty(t *testing.T) {
	// Arrange
...
func Test_Cov4_BytesTo_PtrString_NonEmpty(t *testing.T) {
	// Arrange
...
func Test_Cov4_BytesTo_PointerToBytes_Nil(t *testing.T) {
	// Arrange
...
func Test_Cov4_BytesTo_PointerToBytes_NonNil(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringTo_IntegerDefault_Valid(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringTo_IntegerDefault_Invalid(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringTo_Integer_Valid(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringTo_Integer_Invalid(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringTo_IntegerMust_Valid(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringTo_IntegerMust_Panics(t *testing.T) {
	// Arrange
	var didPanic bool
	func() {
		defer func() {
...
func Test_Cov4_StringTo_IntegersConditional_Empty(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringTo_IntegersConditional_WithBreak(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringTo_IntegersWithDefaults_Empty(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringTo_IntegersWithDefaults_MixedValid(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringTo_Float64_Valid(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringTo_Float64_Invalid(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringTo_Float64Default_Valid(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringTo_Float64Default_Invalid(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringTo_Float64Must_Valid(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringTo_Byte_Empty(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringTo_Byte_Zero(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringTo_Byte_One(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringTo_Byte_Valid(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringTo_Byte_Negative(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringTo_Byte_Over255(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringTo_Byte_NotNumber(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringTo_ByteWithDefault_Valid(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringTo_ByteWithDefault_Invalid(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringTo_JsonBytes(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringsTo_Hashset(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringsTo_IntegersSkipErrors(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringsTo_Csv(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringsTo_CsvUsingPtrStrings_Nil(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringsTo_MapConverter(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringsTo_PointerStrings_Nil(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringsTo_PointerStrings_NonNil(t *testing.T) {
	// Arrange
	lines := []string{"a", "b"}
...
func Test_Cov4_StringsTo_PointerStringsCopy_Nil(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringsTo_PointerStringsCopy_NonNil(t *testing.T) {
	// Arrange
	lines := []string{"x", "y"}
...
func Test_Cov4_StringsTo_HashmapTrimColon(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringsTo_HashmapTrimHyphen(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringsTo_HashmapOptions(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringsTo_HashmapTrim(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringsTo_BytesWithDefaults_Valid(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringsTo_BytesWithDefaults_Invalid(t *testing.T) {
	// Arrange
...
func Test_Cov4_StringsTo_BytesWithDefaults_OutOfRange(t *testing.T) {
	// Arrange
