...
func Test_Cov4_KeyWithLegend_ItemEnumByte(t *testing.T) {
	// Arrange
...
func Test_Cov4_KeyWithLegend_OutputWithoutLegend_AddRegardless(t *testing.T) {
...
func Test_Cov4_KeyWithLegend_Group_Any(t *testing.T) {
	// Arrange
	kl := keymk.NewKeyWithLegend.All(
		keymk.JoinerOption,
		keymk.FullLegends,
...
func Test_Cov4_TemplateReplacer_CompileUsingReplacerMap_NoCurly(t *testing.T) {
	// Arrange
...
func Test_Cov4_NewKeyWithLegend_NoLegendPackage_WithLegend(t *testing.T) {
	// Arrange & Act
...
func Test_Cov4_KeyWithLegend_WithLegend_Brackets(t *testing.T) {
...
func Test_Cov4_Key_AppendChain_SkipEmpty_StringValue(t *testing.T) {
	// Arrange
...
func Test_Cov4_Key_Compile_Brackets_WithAdditional(t *testing.T) {
	// Arrange
...
func Test_Cov4_Key_CompileStrings_Brackets(t *testing.T) {
	// Arrange
...
func Test_Cov4_Key_Finalized_CompileKeys(t *testing.T) {
	// Arrange
...
func Test_Cov4_Key_Compile_NumericItems(t *testing.T) {
	// Arrange
	key := keymk.NewKey.Default("root")
...
func Test_Cov4_CurlyWrapIf_ThroughCompileReplace(t *testing.T) {
...
func Test_Cov4_KeyWithLegend_OutputItemsArray_AllFields(t *testing.T) {
...
func Test_Cov4_KeyWithLegend_UserStringWithoutState_WithLegend(t *testing.T) {
	// Arrange
	kl := keymk.NewKeyWithLegend.All(
		keymk.JoinerOption,
		keymk.FullLegends,
