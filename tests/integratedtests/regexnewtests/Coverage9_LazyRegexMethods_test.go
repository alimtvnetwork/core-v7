...
func Test_Cov9_LazyRegex_FullString_ValidPattern(t *testing.T) {
	// Arrange
...
func Test_Cov9_LazyRegex_FullString_NilReceiver(t *testing.T) {
	// Arrange
...
func Test_Cov9_LazyRegex_FirstMatchLine_ValidMatch(t *testing.T) {
	// Arrange
	lr := regexnew.New.Lazy(`(\d+)`)
...
func Test_Cov9_LazyRegex_FirstMatchLine_NoMatch(t *testing.T) {
	// Arrange
	lr := regexnew.New.Lazy(`(\d+)`)
...
func Test_Cov9_LazyRegex_FirstMatchLine_InvalidPattern(t *testing.T) {
	// Arrange
...
func Test_Cov9_LazyRegex_CompileMust_ValidPattern(t *testing.T) {
	// Arrange
	lr := regexnew.New.Lazy(`^\d+$`)
...
func Test_Cov9_LazyRegex_CompileMust_Panics(t *testing.T) {
	// Arrange
	lr := regexnew.New.Lazy("[invalid")
	panicked := false
...
func Test_Cov9_LazyRegex_OnRequiredCompiledMust_Valid(t *testing.T) {
	// Arrange
	lr := regexnew.New.Lazy(`^\d+$`)
	panicked := false
...
func Test_Cov9_LazyRegex_OnRequiredCompiledMust_NilPanics(t *testing.T) {
	// Arrange
	var lr *regexnew.LazyRegex
	panicked := false
...
func Test_Cov9_LazyRegex_MustBeSafe_InvalidPanics(t *testing.T) {
	// Arrange
	lr := regexnew.New.Lazy("[invalid")
	panicked := false
...
func Test_Cov9_LazyRegex_MustBeSafe_ValidOk(t *testing.T) {
	// Arrange
	lr := regexnew.New.Lazy(`^\d+$`)
	panicked := false
...
func Test_Cov9_LazyRegex_HasError_ValidPattern(t *testing.T) {
	// Arrange
	lr := regexnew.New.Lazy(`^\d+$`)
...
func Test_Cov9_LazyRegex_HasError_InvalidPattern(t *testing.T) {
	// Arrange
	lr := regexnew.New.Lazy("[invalid")
...
func Test_Cov9_LazyRegex_HasAnyIssues_Nil(t *testing.T) {
	// Arrange
	var lr *regexnew.LazyRegex
...
func Test_Cov9_LazyRegex_IsInvalid_Nil(t *testing.T) {
	// Arrange
	var lr *regexnew.LazyRegex
...
func Test_Cov9_LazyRegex_IsFailedMatch_ValidNoMatch(t *testing.T) {
	// Arrange
	lr := regexnew.New.Lazy(`^\d+$`)
...
func Test_Cov9_LazyRegex_IsFailedMatch_ValidMatch(t *testing.T) {
	// Arrange
	lr := regexnew.New.Lazy(`^\d+$`)
...
func Test_Cov9_LazyRegex_IsFailedMatchBytes_InvalidPattern(t *testing.T) {
	// Arrange
	lr := regexnew.New.Lazy("[invalid")
...
func Test_Cov9_LazyRegex_IsFailedMatchBytes_ValidMatch(t *testing.T) {
	// Arrange
	lr := regexnew.New.Lazy(`^\d+$`)
...
func Test_Cov9_LazyRegex_MatchUsingFuncError_Match(t *testing.T) {
	// Arrange
	lr := regexnew.New.Lazy(`^\d+$`)
...
func Test_Cov9_LazyRegex_MatchUsingFuncError_NoMatch(t *testing.T) {
	// Arrange
	lr := regexnew.New.Lazy(`^\d+$`)
	matchFunc := func(r *regexp.Regexp, s string) bool {
		return r.MatchString(s)
...
func Test_Cov9_LazyRegex_CompiledError_Valid(t *testing.T) {
	// Arrange
	lr := regexnew.New.Lazy(`^\d+$`)
...
func Test_Cov9_LazyRegex_Error_Invalid(t *testing.T) {
	// Arrange
	lr := regexnew.New.Lazy("[invalid")
...
func Test_Cov9_LazyRegex_OnRequiredCompiled_Nil(t *testing.T) {
	// Arrange
	var lr *regexnew.LazyRegex
