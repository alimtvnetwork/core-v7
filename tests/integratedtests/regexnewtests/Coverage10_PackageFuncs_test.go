...
func Test_Cov10_MatchUsingCustomizeErrorFuncLock_CustomError(t *testing.T) {
	// Arrange
	customCalled := false
...
func Test_Cov10_MatchUsingCustomizeErrorFuncLock_NilCustomizer(t *testing.T) {
	// Arrange
	matchFunc := func(r *regexp.Regexp, s string) bool {
		return r.MatchString(s)
	}
...
func Test_Cov10_MatchUsingCustomizeErrorFuncLock_Match(t *testing.T) {
	// Arrange
	matchFunc := func(r *regexp.Regexp, s string) bool {
		return r.MatchString(s)
	}
...
func Test_Cov10_MatchUsingFuncErrorLock_Match(t *testing.T) {
	// Arrange
	matchFunc := func(r *regexp.Regexp, s string) bool {
		return r.MatchString(s)
	}
...
func Test_Cov10_MatchUsingFuncErrorLock_NoMatch(t *testing.T) {
	// Arrange
	matchFunc := func(r *regexp.Regexp, s string) bool {
		return r.MatchString(s)
	}
...
func Test_Cov10_MatchErrorLock_Match(t *testing.T) {
	// Arrange & Act
...
func Test_Cov10_MatchErrorLock_NoMatch(t *testing.T) {
	// Arrange & Act
...
func Test_Cov10_IsMatchFailed_True(t *testing.T) {
	// Arrange & Act
...
func Test_Cov10_IsMatchFailed_False(t *testing.T) {
	// Arrange & Act
...
func Test_Cov10_NewCreator_LazyLock(t *testing.T) {
	// Arrange & Act
...
func Test_Cov10_NewCreator_DefaultLockIf_Locked(t *testing.T) {
	// Arrange & Act
...
func Test_Cov10_NewCreator_DefaultLockIf_Unlocked(t *testing.T) {
	// Arrange & Act
...
func Test_Cov10_NewCreator_DefaultApplicableLock(t *testing.T) {
	// Arrange & Act
...
func Test_Cov10_LazyRegexCreator_TwoLock(t *testing.T) {
	// Arrange & Act
...
func Test_Cov10_LazyRegexCreator_ManyUsingLock(t *testing.T) {
	// Arrange & Act
...
func Test_Cov10_LazyRegexCreator_ManyUsingLock_Empty(t *testing.T) {
	// Arrange & Act
...
func Test_Cov10_LazyRegexCreator_AllPatternsMap(t *testing.T) {
	// Arrange
...
func Test_Cov10_LazyRegexCreator_NewLockIf_Locked(t *testing.T) {
	// Arrange & Act
...
func Test_Cov10_LazyRegexCreator_NewLockIf_Unlocked(t *testing.T) {
	// Arrange & Act
...
func Test_Cov10_CreateMustLockIf_Locked(t *testing.T) {
	// Arrange & Act
...
func Test_Cov10_CreateMustLockIf_Unlocked(t *testing.T) {
	// Arrange & Act
...
func Test_Cov10_NewMustLock(t *testing.T) {
	// Arrange & Act
...
func Test_Cov10_CreateApplicableLock_Invalid(t *testing.T) {
	// Arrange & Act
...
func Test_Cov10_CreateLockIf_Locked(t *testing.T) {
	// Arrange & Act
...
func Test_Cov10_CreateLockIf_Unlocked(t *testing.T) {
	// Arrange & Act
...
func Test_Cov10_LazyRegex_MatchError_Match(t *testing.T) {
	// Arrange
...
func Test_Cov10_LazyRegex_MatchError_NoMatch(t *testing.T) {
	// Arrange
	lr := regexnew.New.Lazy(`^\d+$`)
