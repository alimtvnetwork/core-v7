...
func Test_C01_Result_NilReceiver_Map(t *testing.T) {
	// Arrange
...
func Test_C02_Result_NilReceiver_JsonStringPtr(t *testing.T) {
	// Arrange
	var r *corejson.Result
	s := r.JsonStringPtr()
...
func Test_C03_Result_NilReceiver_PrettyJsonString(t *testing.T) {
	// Arrange
	var r *corejson.Result
...
func Test_C04_Result_NilReceiver_PrettyJsonStringOrErrString(t *testing.T) {
	// Arrange
	var r *corejson.Result
...
func Test_C05_Result_PrettyJsonStringOrErrString_WithError(t *testing.T) {
	// Arrange
...
func Test_C06_Result_NilReceiver_Length(t *testing.T) {
	// Arrange
	var r *corejson.Result
...
func Test_C07_Result_NilReceiver_Raw(t *testing.T) {
	// Arrange
	var r *corejson.Result
	b, err := r.Raw()
...
func Test_C08_Result_NilReceiver_MeaningfulError(t *testing.T) {
	// Arrange
	var r *corejson.Result
...
func Test_C09_Result_MeaningfulError_EmptyBytes(t *testing.T) {
	// Arrange
...
func Test_C10_Result_MeaningfulError_WithErrorAndBytes(t *testing.T) {
	// Arrange
...
func Test_C11_Result_MeaningfulError_WithErrorNoBytes(t *testing.T) {
	// Arrange
...
func Test_C12_Result_MeaningfulErrorMessage(t *testing.T) {
	// Arrange
...
func Test_C13_Result_SafeString(t *testing.T) {
	// Arrange
...
func Test_C14_Result_Map_WithBytesErrorType(t *testing.T) {
	r := &corejson.Result{
		Bytes:    []byte(`"data"`),
		Error:    errors.New("e"),
		TypeName: "Foo",
...
func Test_C15_Result_DeserializedFieldsToMap_Nil(t *testing.T) {
	// Arrange
	var r *corejson.Result
...
func Test_C16_Result_SafeDeserializedFieldsToMap(t *testing.T) {
	// Arrange
...
func Test_C17_Result_FieldsNames_Empty(t *testing.T) {
	// Arrange
	r := &corejson.Result{}
...
func Test_C18_Result_SafeFieldsNames(t *testing.T) {
	// Arrange
	r := &corejson.Result{}
...
func Test_C19_Result_BytesTypeName_Nil(t *testing.T) {
	// Arrange
	var r *corejson.Result
...
func Test_C20_Result_SafeBytesTypeName_Empty(t *testing.T) {
	// Arrange
	r := &corejson.Result{}
...
func Test_C21_Result_SafeBytesTypeName_WithType(t *testing.T) {
	// Arrange
...
func Test_C22_Result_ErrorString_NoError(t *testing.T) {
	// Arrange
	r := &corejson.Result{}
...
func Test_C23_Result_IsErrorEqual(t *testing.T) {
	// Arrange
...
func Test_C24_Result_String_NilBytes(t *testing.T) {
	// Arrange
	r := corejson.Result{}
	s := r.String()
...
func Test_C25_Result_String_WithError(t *testing.T) {
	// Arrange
...
func Test_C26_Result_String_NoError(t *testing.T) {
	// Arrange
...
func Test_C27_Result_SafeNonIssueBytes(t *testing.T) {
	// Arrange
...
func Test_C28_Result_SafeNonIssueBytes_Valid(t *testing.T) {
	// Arrange
...
func Test_C29_Result_SafeBytes_Nil(t *testing.T) {
	// Arrange
	var r *corejson.Result
...
func Test_C30_Result_Values(t *testing.T) {
	// Arrange
	r := &corejson.Result{Bytes: []byte(`"x"`)}
...
func Test_C31_Result_SafeValues_Nil(t *testing.T) {
	// Arrange
	var r *corejson.Result
...
func Test_C32_Result_SafeValuesPtr_HasIssues(t *testing.T) {
	// Arrange
	r := &corejson.Result{Error: errors.New("e")}
...
func Test_C33_Result_RawMust(t *testing.T) {
	// Arrange
	r := &corejson.Result{Bytes: []byte(`"ok"`)}
	b := r.RawMust()
...
func Test_C34_Result_RawStringMust(t *testing.T) {
	// Arrange
	r := &corejson.Result{Bytes: []byte(`"ok"`)}
	s := r.RawStringMust()
...
func Test_C35_Result_RawStringMust_Panic(t *testing.T) {
	// Arrange
	r := &corejson.Result{Error: errors.New("e")}
	didPanic := false
	func() {
...
func Test_C36_Result_RawErrString(t *testing.T) {
	// Arrange
	r := &corejson.Result{Bytes: []byte(`"ok"`)}
...
func Test_C37_Result_RawPrettyString(t *testing.T) {
	// Arrange
	r := &corejson.Result{Bytes: []byte(`{"a":1}`)}
...
func Test_C38_Result_PrettyJsonBuffer_Empty(t *testing.T) {
	// Arrange
	r := &corejson.Result{}
...
func Test_C39_Result_PrettyJsonString_InvalidJson(t *testing.T) {
	// Arrange
...
func Test_C40_Result_HasSafeItems(t *testing.T) {
	// Arrange
	r := &corejson.Result{Bytes: []byte(`"ok"`)}
...
func Test_C41_Result_HandleError_Panic(t *testing.T) {
	// Arrange
	r := &corejson.Result{}
	didPanic := false
	func() {
...
func Test_C42_Result_HandleErrorWithMsg_Panic(t *testing.T) {
	// Arrange
	r := &corejson.Result{}
	didPanic := false
	func() {
...
func Test_C43_Result_HasBytes_HasJsonBytes(t *testing.T) {
	// Arrange
	r := &corejson.Result{Bytes: []byte(`"ok"`)}
...
func Test_C44_Result_IsEmptyJsonBytes_CurlyBrace(t *testing.T) {
	// Arrange
...
func Test_C45_Result_IsEmptyJsonBytes_Nil(t *testing.T) {
	// Arrange
	var r *corejson.Result
...
func Test_C46_Result_HasAnyItem(t *testing.T) {
	// Arrange
	r := corejson.Result{Bytes: []byte(`"x"`)}
...
func Test_C47_Result_HasJson_IsEmptyJson(t *testing.T) {
	// Arrange
	r := &corejson.Result{Bytes: []byte(`"x"`)}
...
func Test_C48_Result_Unmarshal_NilReceiver(t *testing.T) {
	// Arrange
	var r *corejson.Result
	var s string
	err := r.Unmarshal(&s)
...
func Test_C49_Result_Unmarshal_WithExistingError(t *testing.T) {
	// Arrange
...
func Test_C50_Result_Unmarshal_InvalidJson(t *testing.T) {
	// Arrange
	r := &corejson.Result{Bytes: []byte(`not-json`)}
	var s string
	err := r.Unmarshal(&s)
...
func Test_C51_Result_DeserializeMust_Panic(t *testing.T) {
	// Arrange
	r := &corejson.Result{Error: errors.New("e")}
	didPanic := false
	func() {
...
func Test_C52_Result_UnmarshalMust_Panic(t *testing.T) {
	// Arrange
	r := &corejson.Result{Error: errors.New("e")}
	didPanic := false
	func() {
...
func Test_C53_Result_SerializeSkipExistingIssues(t *testing.T) {
	// Arrange
	r := &corejson.Result{Error: errors.New("e")}
...
func Test_C54_Result_SerializeSkipExistingIssues_Valid(t *testing.T) {
	// Arrange
	r := &corejson.Result{Bytes: []byte(`"x"`)}
	b, err := r.SerializeSkipExistingIssues()
...
func Test_C55_Result_Serialize_Nil(t *testing.T) {
	// Arrange
	var r *corejson.Result
	b, err := r.Serialize()
...
func Test_C56_Result_Serialize_WithError(t *testing.T) {
	// Arrange
	r := &corejson.Result{Error: errors.New("e")}
	b, err := r.Serialize()
...
func Test_C57_Result_Serialize_Valid(t *testing.T) {
	// Arrange
	r := &corejson.Result{Bytes: []byte(`"x"`), TypeName: "T"}
	b, err := r.Serialize()
...
func Test_C58_Result_SerializeMust(t *testing.T) {
	// Arrange
	r := &corejson.Result{Bytes: []byte(`"x"`), TypeName: "T"}
	b := r.SerializeMust()
...
func Test_C59_Result_UnmarshalSkipExistingIssues_HasIssues(t *testing.T) {
	// Arrange
	r := &corejson.Result{Error: errors.New("e")}
	var s string
...
func Test_C60_Result_UnmarshalSkipExistingIssues_Valid(t *testing.T) {
	// Arrange
...
func Test_C61_Result_UnmarshalSkipExistingIssues_BadJson(t *testing.T) {
	// Arrange
	r := &corejson.Result{Bytes: []byte(`not-json`)}
	var s string
	err := r.UnmarshalSkipExistingIssues(&s)
...
func Test_C62_Result_UnmarshalResult(t *testing.T) {
	// Arrange
...
func Test_C63_Result_JsonModel_Nil(t *testing.T) {
	// Arrange
	var r *corejson.Result
	model := r.JsonModel()
...
func Test_C64_Result_JsonModel_Valid(t *testing.T) {
	// Arrange
	r := &corejson.Result{Bytes: []byte(`"x"`)}
	model := r.JsonModel()
...
func Test_C65_Result_JsonModelAny(t *testing.T) {
	// Arrange
	r := &corejson.Result{Bytes: []byte(`"x"`)}
	a := r.JsonModelAny()
...
func Test_C66_Result_Json_JsonPtr(t *testing.T) {
	// Arrange
	r := corejson.Result{Bytes: []byte(`"x"`)}
	j := r.Json()
	jp := r.JsonPtr()
...
func Test_C67_Result_ParseInjectUsingJson(t *testing.T) {
	// Arrange
	r := &corejson.Result{}
...
func Test_C68_Result_ParseInjectUsingJson_Error(t *testing.T) {
	// Arrange
	r := &corejson.Result{}
...
func Test_C69_Result_ParseInjectUsingJsonMust_Panic(t *testing.T) {
	// Arrange
	r := &corejson.Result{}
	input := &corejson.Result{Bytes: []byte(`not-json`)}
	didPanic := false
...
func Test_C70_Result_CloneError(t *testing.T) {
	// Arrange
	r := &corejson.Result{Error: errors.New("e")}
...
func Test_C71_Result_Ptr_NonPtr(t *testing.T) {
	// Arrange
	r := corejson.Result{Bytes: []byte(`"x"`)}
	p := r.Ptr()
	np := p.NonPtr()
...
func Test_C72_Result_NonPtr_Nil(t *testing.T) {
	// Arrange
	var r *corejson.Result
	np := r.NonPtr()
...
func Test_C73_Result_ToPtr_ToNonPtr(t *testing.T) {
	// Arrange
	r := corejson.Result{Bytes: []byte(`"x"`)}
	p := r.ToPtr()
	np := r.ToNonPtr()
...
func Test_C74_Result_IsEqualPtr(t *testing.T) {
	// Arrange
...
func Test_C75_Result_IsEqualPtr_DiffType(t *testing.T) {
	// Arrange
...
func Test_C76_Result_IsEqualPtr_DiffErr(t *testing.T) {
	// Arrange
...
func Test_C77_Result_CombineErrorWithRefString(t *testing.T) {
	// Arrange
	r := &corejson.Result{Error: errors.New("e")}
...
func Test_C78_Result_CombineErrorWithRefString_NoError(t *testing.T) {
	// Arrange
	r := &corejson.Result{}
...
func Test_C79_Result_CombineErrorWithRefError(t *testing.T) {
	// Arrange
	r := &corejson.Result{Error: errors.New("e")}
...
func Test_C80_Result_IsEqual(t *testing.T) {
	// Arrange
...
func Test_C81_Result_BytesError(t *testing.T) {
	// Arrange
...
func Test_C82_Result_Dispose(t *testing.T) {
	// Arrange
	r := &corejson.Result{Bytes: []byte(`"x"`), Error: errors.New("e"), TypeName: "T"}
	r.Dispose()
...
func Test_C83_Result_CloneIf(t *testing.T) {
	// Arrange
	r := corejson.Result{Bytes: []byte(`"x"`), TypeName: "T"}
...
func Test_C84_Result_ClonePtr(t *testing.T) {
	// Arrange
	r := &corejson.Result{Bytes: []byte(`"x"`), TypeName: "T"}
...
func Test_C85_Result_Clone_ShallowAndDeep(t *testing.T) {
	// Arrange
	r := corejson.Result{Bytes: []byte(`"x"`), TypeName: "T"}
...
func Test_C86_Result_Clone_Empty(t *testing.T) {
	// Arrange
	r := corejson.Result{}
	cloned := r.Clone(true)
...
func Test_C87_Result_AsInterfaces(t *testing.T) {
	// Arrange
	r := corejson.Result{Bytes: []byte(`"x"`)}
...
func Test_C88_Result_JsonParseSelfInject(t *testing.T) {
	// Arrange
	r := corejson.Result{}
	input := corejson.NewResult.AnyPtr(corejson.Result{Bytes: []byte(`"injected"`), TypeName: "T"})
...
func Test_C89_Result_InjectInto(t *testing.T) {
	r := &corejson.Result{Bytes: []byte(`"x"`)}
...
func Test_C90_CastAny_FromToDefault(t *testing.T) {
	// Arrange
	var out string
...
func Test_C91_CastAny_FromToReflection(t *testing.T) {
	// Arrange
	var out string
...
func Test_C92_CastAny_FromToOption_Nil(t *testing.T) {
	// Arrange
...
func Test_C93_CastAny_FromToOption_String(t *testing.T) {
	// Arrange
...
func Test_C94_CastAny_FromToOption_Error(t *testing.T) {
	// Arrange
	var out string
...
func Test_C95_CastAny_FromToOption_NilError(t *testing.T) {
	// Arrange
	var nilErr error
	var out string
...
func Test_C96_CastAny_FromToOption_SerializerFunc(t *testing.T) {
	// Arrange
...
func Test_C97_CastAny_FromToOption_AnyItem(t *testing.T) {
	// Arrange
	type s struct{ A int }
	var out s
...
func Test_C98_CastAny_OrDeserializeTo(t *testing.T) {
	// Arrange
	var out string
...
func Test_C99_AnyTo_SerializedJsonResult_Nil(t *testing.T) {
	// Arrange
...
func Test_C100_AnyTo_SerializedJsonResult_Error(t *testing.T) {
	// Arrange
...
func Test_C101_AnyTo_SerializedJsonResult_EmptyError(t *testing.T) {
	// Arrange
...
func Test_C102_AnyTo_SerializedRaw(t *testing.T) {
	// Arrange
...
func Test_C103_AnyTo_SerializedString(t *testing.T) {
	// Arrange
...
func Test_C104_AnyTo_SerializedString_Error(t *testing.T) {
	// Arrange
...
func Test_C105_AnyTo_SerializedSafeString(t *testing.T) {
	// Arrange
...
func Test_C106_AnyTo_SerializedSafeString_Error(t *testing.T) {
	// Arrange
...
func Test_C107_AnyTo_SerializedStringMust(t *testing.T) {
	// Arrange
...
func Test_C108_AnyTo_SafeJsonString(t *testing.T) {
	// Arrange
...
func Test_C109_AnyTo_PrettyStringWithError(t *testing.T) {
	// Arrange
...
func Test_C110_AnyTo_PrettyStringWithError_Bytes(t *testing.T) {
	// Arrange
...
func Test_C111_AnyTo_PrettyStringWithError_Result(t *testing.T) {
	// Arrange
	r := corejson.Result{Bytes: []byte(`{"a":1}`)}
...
func Test_C112_AnyTo_PrettyStringWithError_ResultPtr(t *testing.T) {
	// Arrange
	r := &corejson.Result{Bytes: []byte(`{"a":1}`)}
	s, err := corejson.AnyTo.PrettyStringWithError(r)
...
func Test_C113_AnyTo_PrettyStringWithError_ResultWithErr(t *testing.T) {
...
func Test_C114_AnyTo_PrettyStringWithError_ResultPtrWithErr(t *testing.T) {
	r := &corejson.Result{Bytes: []byte(`{"a":1}`), Error: errors.New("e")}
	s, err := corejson.AnyTo.PrettyStringWithError(r)
	_ = s
	_ = err
...
func Test_C115_AnyTo_SafeJsonPrettyString(t *testing.T) {
	// Arrange
...
func Test_C116_AnyTo_SafeJsonPrettyString_Bytes(t *testing.T) {
	// Arrange
...
func Test_C117_AnyTo_SafeJsonPrettyString_Result(t *testing.T) {
	// Arrange
	r := corejson.Result{Bytes: []byte(`{"a":1}`)}
...
func Test_C118_AnyTo_SafeJsonPrettyString_ResultPtr(t *testing.T) {
	// Arrange
	r := &corejson.Result{Bytes: []byte(`{"a":1}`)}
	s := corejson.AnyTo.SafeJsonPrettyString(r)
...
func Test_C119_AnyTo_JsonString(t *testing.T) {
	// Arrange
...
func Test_C120_AnyTo_JsonString_Bytes(t *testing.T) {
	// Arrange
...
func Test_C121_AnyTo_JsonString_Result(t *testing.T) {
	// Arrange
	r := corejson.Result{Bytes: []byte(`"x"`)}
...
func Test_C122_AnyTo_JsonString_ResultPtr(t *testing.T) {
	// Arrange
	r := &corejson.Result{Bytes: []byte(`"x"`)}
	s := corejson.AnyTo.JsonString(r)
...
func Test_C123_AnyTo_JsonStringWithErr(t *testing.T) {
	// Arrange
...
func Test_C124_AnyTo_JsonStringWithErr_Bytes(t *testing.T) {
	// Arrange
...
func Test_C125_AnyTo_JsonStringWithErr_ResultWithErr(t *testing.T) {
...
func Test_C126_AnyTo_JsonStringWithErr_ResultPtrWithErr(t *testing.T) {
	r := &corejson.Result{Error: errors.New("e"), Bytes: []byte(`"x"`)}
	s, err := corejson.AnyTo.JsonStringWithErr(r)
...
func Test_C127_AnyTo_JsonStringMust(t *testing.T) {
	// Arrange
...
func Test_C128_AnyTo_PrettyStringMust(t *testing.T) {
	// Arrange
...
func Test_C129_AnyTo_UsingSerializer(t *testing.T) {
	// Arrange
...
func Test_C130_AnyTo_SerializedFieldsMap(t *testing.T) {
	// Arrange
	type s struct{ A int }
...
func Test_C131_Deserialize_UsingStringPtr_Nil(t *testing.T) {
	// Arrange
	var s string
...
func Test_C132_Deserialize_UsingStringPtr_Valid(t *testing.T) {
	// Arrange
	str := `"hello"`
	var out string
...
func Test_C133_Deserialize_UsingError_Nil(t *testing.T) {
	// Arrange
	var out string
...
func Test_C134_Deserialize_UsingError_Valid(t *testing.T) {
	// Arrange
	var out string
...
func Test_C135_Deserialize_UsingErrorWhichJsonResult(t *testing.T) {
	// Arrange
	var out string
...
func Test_C136_Deserialize_ApplyMust_Panic(t *testing.T) {
	// Arrange
	r := &corejson.Result{Error: errors.New("e")}
	didPanic := false
	func() {
...
func Test_C137_Deserialize_FromString(t *testing.T) {
	// Arrange
	var out string
...
func Test_C138_Deserialize_FromStringMust(t *testing.T) {
	// Arrange
	var out string
...
func Test_C139_Deserialize_FromStringMust_Panic(t *testing.T) {
	// Arrange
	didPanic := false
	func() {
		defer func() {
...
func Test_C140_Deserialize_MapAnyToPointer(t *testing.T) {
	// Arrange
	type s struct {
		A int `json:"a"`
	}
...
func Test_C141_Deserialize_MapAnyToPointer_SkipEmpty(t *testing.T) {
	// Arrange
	var out string
...
func Test_C142_Deserialize_UsingStringOption(t *testing.T) {
	// Arrange
	var out string
...
func Test_C143_Deserialize_UsingStringIgnoreEmpty(t *testing.T) {
	// Arrange
	var out string
...
func Test_C144_Deserialize_UsingBytesPointer_Nil(t *testing.T) {
	// Arrange
	var out string
...
func Test_C145_Deserialize_UsingBytesPointerMust_Panic(t *testing.T) {
	// Arrange
	didPanic := false
	func() {
		defer func() {
...
func Test_C146_Deserialize_UsingBytesIf(t *testing.T) {
	// Arrange
	var out string
...
func Test_C147_Deserialize_UsingBytesPointerIf(t *testing.T) {
	// Arrange
	var out string
...
func Test_C148_Deserialize_UsingBytesMust(t *testing.T) {
	// Arrange
	var out string
...
func Test_C149_Deserialize_UsingSafeBytesMust_Empty(t *testing.T) {
	// Arrange
	var out string
...
func Test_C150_Deserialize_AnyToFieldsMap(t *testing.T) {
	// Arrange
	type s struct{ A int }
...
func Test_C151_Deserialize_UsingDeserializerToOption_SkipNil(t *testing.T) {
	// Arrange
	var out string
...
func Test_C152_Deserialize_UsingDeserializerToOption_NilNotSkipped(t *testing.T) {
	// Arrange
	var out string
...
func Test_C153_Deserialize_UsingDeserializerFuncDefined_Nil(t *testing.T) {
	// Arrange
	var out string
...
func Test_C154_Deserialize_UsingDeserializerFuncDefined_Valid(t *testing.T) {
	// Arrange
...
func Test_C155_Deserialize_UsingJsonerToAny_SkipNil(t *testing.T) {
	// Arrange
	var out string
...
func Test_C156_Deserialize_UsingJsonerToAny_NilNotSkipped(t *testing.T) {
	// Arrange
	var out string
...
func Test_C157_Deserialize_UsingJsonerToAnyMust_SkipNil(t *testing.T) {
	// Arrange
	var out string
...
func Test_C158_Deserialize_UsingJsonerToAnyMust_NilNotSkipped(t *testing.T) {
	// Arrange
	var out string
...
func Test_C159_BytesCloneIf_NoClone(t *testing.T) {
	// Arrange
...
func Test_C160_BytesCloneIf_Clone(t *testing.T) {
	// Arrange
...
func Test_C161_BytesCloneIf_Empty(t *testing.T) {
	// Arrange
...
func Test_C162_BytesDeepClone(t *testing.T) {
	// Arrange
...
func Test_C163_BytesDeepClone_Empty(t *testing.T) {
	// Arrange
...
func Test_C164_BytesToString(t *testing.T) {
	// Act
...
func Test_C165_BytesToString_Empty(t *testing.T) {
	// Act
...
func Test_C166_BytesToPrettyString(t *testing.T) {
	// Arrange
...
func Test_C167_BytesToPrettyString_Empty(t *testing.T) {
	// Act
...
func Test_C168_JsonString_Func(t *testing.T) {
	// Arrange
...
func Test_C169_Serialize_StringsApply(t *testing.T) {
	// Arrange
...
func Test_C170_Serialize_FromBytes(t *testing.T) {
	// Arrange
...
func Test_C171_Serialize_FromStrings(t *testing.T) {
	// Arrange
...
func Test_C172_Serialize_FromStringsSpread(t *testing.T) {
	// Arrange
...
func Test_C173_Serialize_FromString(t *testing.T) {
	// Arrange
...
func Test_C174_Serialize_FromInteger(t *testing.T) {
	// Arrange
...
func Test_C175_Serialize_FromInteger64(t *testing.T) {
	// Arrange
...
func Test_C176_Serialize_FromBool(t *testing.T) {
	// Arrange
...
func Test_C177_Serialize_FromIntegers(t *testing.T) {
	// Arrange
...
func Test_C178_Serialize_FromStringer(t *testing.T) {
	// Arrange
...
func Test_C179_Serialize_UsingAnyPtr(t *testing.T) {
	// Arrange
...
func Test_C180_Serialize_UsingAny(t *testing.T) {
	// Arrange
...
func Test_C181_Serialize_Raw(t *testing.T) {
	// Arrange
...
func Test_C182_Serialize_Marshal(t *testing.T) {
	// Arrange
...
func Test_C183_Serialize_ApplyMust(t *testing.T) {
	// Arrange
...
func Test_C184_Serialize_ToBytesMust(t *testing.T) {
	// Arrange
...
func Test_C185_Serialize_ToSafeBytesMust(t *testing.T) {
	// Arrange
...
func Test_C186_Serialize_ToSafeBytesSwallowErr(t *testing.T) {
	// Arrange
...
func Test_C187_Serialize_ToBytesSwallowErr(t *testing.T) {
	// Arrange
...
func Test_C188_Serialize_ToBytesErr(t *testing.T) {
	// Arrange
...
func Test_C189_Serialize_ToString(t *testing.T) {
	// Arrange
...
func Test_C190_Serialize_ToStringMust(t *testing.T) {
	// Arrange
...
func Test_C191_Serialize_ToStringErr(t *testing.T) {
	// Arrange
...
func Test_C192_Serialize_ToPrettyStringErr(t *testing.T) {
	// Arrange
...
func Test_C193_Serialize_ToPrettyStringIncludingErr(t *testing.T) {
	// Arrange
...
func Test_C194_Serialize_Pretty(t *testing.T) {
	// Arrange
...
func Test_C195_BytesTo_Bool(t *testing.T) {
	// Arrange
...
func Test_C196_BytesTo_BoolMust(t *testing.T) {
	// Arrange
...
func Test_C197_BytesTo_Integer(t *testing.T) {
	// Arrange
...
func Test_C198_BytesTo_IntegerMust(t *testing.T) {
	// Arrange
...
func Test_C199_BytesTo_Integer64(t *testing.T) {
	// Arrange
...
func Test_C200_BytesTo_Integer64Must(t *testing.T) {
	// Arrange
...
func Test_C201_BytesTo_Integers(t *testing.T) {
	// Arrange
...
func Test_C202_BytesTo_IntegersMust(t *testing.T) {
	// Arrange
...
func Test_C203_BytesTo_Strings(t *testing.T) {
	// Arrange
...
func Test_C204_BytesTo_StringsMust(t *testing.T) {
	// Arrange
...
func Test_C205_BytesTo_String(t *testing.T) {
	// Arrange
...
func Test_C206_BytesTo_StringMust(t *testing.T) {
	// Arrange
...
func Test_C207_BytesTo_MapAnyItem(t *testing.T) {
	// Arrange
...
func Test_C208_BytesTo_MapAnyItemMust(t *testing.T) {
	// Arrange
...
func Test_C209_BytesTo_MapStringString(t *testing.T) {
	// Arrange
...
func Test_C210_BytesTo_MapStringStringMust(t *testing.T) {
	// Arrange
...
func Test_C211_BytesTo_Bytes(t *testing.T) {
	// Arrange
...
func Test_C212_BytesTo_BytesMust(t *testing.T) {
	// Arrange
...
func Test_C213_ResultTo_Byte(t *testing.T) {
	// Arrange
...
func Test_C214_ResultTo_ByteMust(t *testing.T) {
	// Arrange
	r := corejson.NewResult.AnyPtr(byte(65))
...
func Test_C215_Empty_ResultWithErr(t *testing.T) {
	// Arrange
...
func Test_C216_Empty_ResultPtrWithErr(t *testing.T) {
	// Arrange
...
func Test_C217_Empty_BytesCollection(t *testing.T) {
	// Arrange
...
func Test_C218_Empty_BytesCollectionPtr(t *testing.T) {
	// Arrange
...
func Test_C219_Empty_ResultsPtrCollection(t *testing.T) {
	// Arrange
...
func Test_C220_Empty_MapResults(t *testing.T) {
	// Arrange
...
func Test_C221_NewResult_PtrUsingStringPtr_Nil(t *testing.T) {
	// Arrange
...
func Test_C222_NewResult_PtrUsingStringPtr_Valid(t *testing.T) {
	// Arrange
	s := `"hello"`
...
func Test_C223_NewResult_UsingErrorStringPtr(t *testing.T) {
	// Arrange
...
func Test_C224_NewResult_UsingErrorStringPtr_Valid(t *testing.T) {
	// Arrange
	s := `"hello"`
...
func Test_C225_NewResult_UsingTypePlusStringPtr_Nil(t *testing.T) {
	// Arrange
...
func Test_C226_NewResult_UsingTypePlusStringPtr_Valid(t *testing.T) {
	// Arrange
	s := `"hello"`
...
func Test_C227_NewResult_UsingStringPtr_Nil(t *testing.T) {
	// Arrange
...
func Test_C228_NewResult_UsingStringPtr_Valid(t *testing.T) {
	// Arrange
	s := `"hello"`
...
func Test_C229_NewResult_UsingBytesPtr_Nil(t *testing.T) {
	// Arrange
...
func Test_C230_NewResult_UsingBytesPtrErrPtr(t *testing.T) {
	// Arrange
...
func Test_C231_NewResult_UsingBytesErrPtr_Empty(t *testing.T) {
	// Arrange
...
func Test_C232_NewResult_UsingSerializer_Nil(t *testing.T) {
	// Arrange
...
func Test_C233_NewResult_UsingSerializerFunc_Nil(t *testing.T) {
	// Arrange
...
func Test_C234_NewResult_UsingJsoner_Nil(t *testing.T) {
	// Arrange
...
func Test_C235_NewResult_Many(t *testing.T) {
	// Arrange
...
func Test_C236_NewResult_AnyToCastingResult(t *testing.T) {
	// Arrange
...
func Test_C237_StaticJsonError(t *testing.T) {
	// Act
