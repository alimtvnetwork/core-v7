...
func Test_Cov17_CompiledError_NilMainErr(t *testing.T) {
	// Arrange
	var nilErr error
...
func Test_Cov17_RawErrCollection_CompiledJsonErrorWithStackTraces(t *testing.T) {
	// Arrange
...
func Test_Cov17_RawErrCollection_CompiledJsonStringWithStackTraces(t *testing.T) {
	// Arrange
	coll := &errcore.RawErrCollection{
...
func Test_Cov17_RawErrCollection_SerializeWithoutTraces(t *testing.T) {
	// Arrange
	coll := &errcore.RawErrCollection{
...
func Test_Cov17_RawErrCollection_Serialize(t *testing.T) {
	// Arrange
	coll := &errcore.RawErrCollection{
		Items: []error{errors.New("test error")},
	}
...
func Test_Cov17_RawErrCollection_SerializeMust(t *testing.T) {
	// Arrange
	coll := &errcore.RawErrCollection{
