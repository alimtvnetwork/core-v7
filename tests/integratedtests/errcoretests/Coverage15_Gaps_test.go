...
func Test_Cov15_HandleCompiledErrorGetter_NilError(t *testing.T) {
...
func Test_Cov15_HandleCompiledErrorWithTracesGetter_NilError(t *testing.T) {
	// Arrange
...
func Test_Cov15_HandleErrorGetter_NilError(t *testing.T) {
	// Arrange
...
func Test_Cov15_HandleFullStringsWithTracesGetter_NilError(t *testing.T) {
	// Arrange
