...
func Test_Cov3_Version_NilReceiver(t *testing.T) {
	// Arrange
...
func Test_Cov3_Version_IsVersionCompareEqual_Nil(t *testing.T) {
	// Arrange
	var v *coreversion.Version
...
func Test_Cov3_Version_InvalidOrZero(t *testing.T) {
	// Arrange
...
func Test_Cov3_Version_String_And_AllValues(t *testing.T) {
	// Arrange
	v := coreversion.New.Create("1.2.3.4")
...
func Test_Cov3_Version_MajorMinorPatchBuild_Comparisons(t *testing.T) {
	// Arrange
	v := coreversion.New.Create("1.2.3.4")
...
func Test_Cov3_CompareVersionString(t *testing.T) {
	// Act
	actual := args.Map{
...
func Test_Cov3_VersionsCollection_AddSkipInvalid(t *testing.T) {
	// Arrange
